...
from axion.scoring.dimensions import (
    SCHOOL_LABELS,
    SCHOOL_QUESTIONS,
    BuffettResult,
    DalioResult,
...
from axion.scoring.rules import get_rules

# 导入规则模块，触发 @rule 装饰器注册
import axion.scoring.v1.buffett  # noqa: F401
import axion.scoring.v1.dalio  # noqa: F401
import axion.scoring.v1.soros  # noqa: F401
