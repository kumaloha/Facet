...
from axion.features.types import ComputeContext, FeatureResult
from axion.features.registry import get_features
from axion.scoring.scorer import score_company, format_report
...
def compute_all_features(ctx: ComputeContext) -> dict[str, FeatureResult]:
    from axion.features.types import FeatureLevel
    results = {}
